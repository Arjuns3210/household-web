    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 offset-md-3" id="form" style="border: #E6BF83 4px solid">
                <center class="regis"><b>Service Provider Register Here</b></center>
                <form  method="POST" onsubmit="return validateForm();" enctype="multipart/form-data">
                    ...
                    <div class="form-group mt-2">
                        <label>Address</label>
                        <textarea class="form-control" rows="3" placeholder="Enter Address" name="address" required pattern="[A-Za-z0-9]{3,60}" autocomplete="off"></textarea>
                    </div>
                    <div class="form-group mt-2">
                    ...
                    <div class="form-group offset-md-4 mt-4">
                      ...
                      <b><a class="btn btn-primary mx-3" href="index.php">Back</a><b>
                    </div>
                    <div class="form-group offset-md-2 mt-4">
                        <h4>Already have an account ? <a href="providerlogin.php" style="text-decoration:none">Login Here</a></h4>
                    </div>
                </form>
