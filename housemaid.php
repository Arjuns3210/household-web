...
<body>
    <nav>
        ...
        <h6 class="text-center mt-2">Enjoy The Comforts Of Not Having To Do Domestic Chores, Hire A Trained, Trustworthy And Hygienic Maid.</h6>
        ...
        <div class="table-responsive-md ">
            <table class="table table-bordered mt-4">
                ...
                <?php
                    ...
                    $query = "SELECT * FROM `sprovider` WHERE profession='Housemaid'";
                    ...
                    {
                        echo"<h3>Housemaids are not available.</h3>";
                    }
