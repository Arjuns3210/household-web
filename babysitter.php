...
<body>
    <nav>
        <div class="navbar navbar-expand-lg" style="background-color: skyblue;">
            ...
            <h2 class="offset-md-5">Babysitter Details</h2>
                <ul class="navbar-nav">
        ...
        <h6 class="text-center mt-2">Now Your Child Will Have His / Her Own Personal Babysitter To Pamper And Take Care Of Him / Her When You’re Busy.</h6>
        ...
        <div class="table-responsive-md ">
            <table class="table table-bordered mt-4">
                ...
                <?php
                    ...
                    $query = "SELECT * FROM `sprovider` WHERE profession='Babysitter'";
                    ...
                    {
                        echo"<h3>Babysitters are not available.</h3>";
                    }
                    ?>
                </tbody>
            </table>
