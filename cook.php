...
<body>
    <nav>
        <div class="navbar navbar-expand-lg" style="background-color: skyblue;">
            ...
            <h2 class="offset-md-5">Cook Details</h2>
                <ul class="navbar-nav">
        ...
        <h6 class="text-center mt-2">Enjoy The Food Prepared By Our Experienced Hygienic Cook.</h6>
        ...
        <div class="table-responsive-md ">
            <table class="table table-bordered mt-4">
                ...
                <?php
                    ...
                    $query = "SELECT * FROM `sprovider` WHERE profession='Cook'";
                    ...
                    {
                        echo"<h3>Cooks are not available.</h3>";
                    }
                    ?>
                </tbody>
            </table>
